...
6. **Request tests** via `bin/orch-shared request-test <orch_id> review-lead "<command>"` — do NOT spawn your own validator
7. **Synthesize** worker outputs into your result file
8. **Write result** to `/tmp/caf_orch/<orch_id>/results/review-lead.md`
