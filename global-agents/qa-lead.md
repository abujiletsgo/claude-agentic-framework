...
4. **Write your domain spec** to `/tmp/caf_orch/<orch_id>/results/qa-lead-spec.md`:
...
7. **Request tests** via `bin/orch-shared request-test <orch_id> qa-lead "<command>"` — do NOT spawn your own validator
8. **Synthesize** worker outputs into your result file
9. **Write result** to `/tmp/caf_orch/<orch_id>/results/qa-lead.md`
...
bin/orch-shared ask-pm <orch_id> qa-lead "Need <other-lead> for <reason>." critical=yes
