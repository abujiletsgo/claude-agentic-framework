...
- **14 Agents** — Opus-first (2 Opus + 3 Haiku)
- **16 Commands** for delegation, orchestration, and planning
- **24 Skills** for the full engineering lifecycle
- **10 Guides** covering context engineering to multi-agent patterns
- **39 Hooks** across 16 event types (damage-control, observability, framework)
...
global-hooks/        39 hooks across 16 events
...
<!-- AUTO-DOC-STAMP:14a-16c-24s-39h -->
