...
- **17 Agents** — Opus-first (2 Opus + 3 Haiku)
- **16 Commands** for delegation, orchestration, and planning
- **29 Skills** for the full engineering lifecycle
- **10 Guides** covering context engineering to multi-agent patterns
- **45 Hooks** across 16 event types (damage-control, observability, framework)
...
global-hooks/        45 hooks across 16 events
...
<!-- AUTO-DOC-STAMP:17a-16c-29s-45h -->
