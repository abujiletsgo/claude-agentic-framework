...
- **8 Agents** — 1 Fable + 2 Opus + 5 Sonnet
- **9 Commands** for delegation, orchestration, and planning
- **16 Skills** for the full engineering lifecycle
- **10 Guides** covering context engineering to multi-agent patterns
- **31 Hooks** across 16 event types (damage-control, observability, framework)
