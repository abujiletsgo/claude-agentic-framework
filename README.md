...
- **12 Agents** — Opus-first (2 Opus + 3 Haiku)
- **16 Commands** for delegation, orchestration, and planning
- **20 Skills** for the full engineering lifecycle
- **10 Guides** covering context engineering to multi-agent patterns
- **42 Hooks** across 16 event types (damage-control, observability, framework)
...
global-hooks/        42 hooks across 16 events
...
<!-- AUTO-DOC-STAMP:12a-16c-20s-42h -->
