...
- **18 Hooks** across 4 event types (damage-control, observability, framework)
...
global-hooks/        18 hooks across 4 events
...
| Event | Count | Purpose |
|-------|-------|---------|
| PreToolUse | 3 | Damage control, security validation |
| PostToolUse | 9 | Context bundle logging |
| Stop | 2 | L-thread progress validation |
| SessionStart | 4 | Skills integrity verification |
