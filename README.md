...
- **9 Skills** for the full engineering lifecycle
- **16 Guides** covering context engineering to multi-agent patterns
- **30 Hooks** across 9 event types (damage-control, observability, framework)
...
global-hooks/        30 hooks across 9 events
guides/              16 engineering guides
...
| `guides/` | 16 engineering guides (context, multi-agent, RLM, etc.) |
...
See `guides/` for 16 comprehensive engineering guides and `docs/` for 11 reference documents.
