...
- **9 Agents** — Opus-first (3 Opus + 1 Haiku)
- **15 Commands** for delegation, orchestration, and planning
- **12 Skills** for the full engineering lifecycle
- **10 Guides** covering context engineering to multi-agent patterns
- **35 Hooks** across 16 event types (damage-control, observability, framework)
...
global-hooks/        35 hooks across 16 events
